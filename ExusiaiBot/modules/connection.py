            ...
            if (bot.get_chat_member(
                ...
                if connection_status:
                    ...
                    if history:
                        ...
                        if (number == 1 and connect_chat != history2
                                and connect_chat != history3):
                            history1 = connect_chat
                            number = 2
                        elif (number == 2 and connect_chat != history1
                              and connect_chat != history3):
                            history2 = connect_chat
                            number = 3
                        elif (number >= 3 and connect_chat != history2
...
def connected(bot, update, chat, user_id, need_admin=True):
    ...
    if chat.type == chat.PRIVATE and sql.get_connected_chat(user_id):
        ...
        if (bot.get_chat_member(
            ...
            if need_admin:
                if (bot.get_chat_member(
                        conn_id, update.effective_message.from_user.id).status
